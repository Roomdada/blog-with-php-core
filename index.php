            ...
            <div class="card shadow-sm">
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group">
                    <button type="button" class="btn btn-primary btn-outline-secondary"><a style="text-decoration:none;" class="text-white" href="config/article.php?id=<?= $value['id'] ?>">Voir les articles</a></button>
                  </div>
