...
<main>
  ...
  <div class="album py-5 bg-light">
    <div class="container">
      <h3 class="text-center mb-4">Categorie d'article de blog</h3>
            ...
            <div class="card shadow-sm">
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group">
                    <button type="button" class="btn btn-primary btn-outline-secondary"><a style="text-decoration:none;" class="text-white" href="details-blog.php?article_id=<?=$value->id?>">Voir details</a></button>
                  </div>
